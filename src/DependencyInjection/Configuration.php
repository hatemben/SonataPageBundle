...
EOF;
        ...
        $node
            ...
            ->arrayNode('class')
                ...
                ->children()
                    ->scalarNode('page')
                        ->defaultValue('App\\Application\\Sonata\\PageBundle\\Document\\Page')
                    ->end()
                    ->scalarNode('snapshot')
                        ->defaultValue('App\\Application\\Sonata\\PageBundle\\Document\\Snapshot')
                    ->end()
                    ->scalarNode('block')
                        ->defaultValue('App\\Application\\Sonata\\PageBundle\\Document\\Block')
                    ->end()
                    ->scalarNode('site')
                        ->defaultValue('App\\Application\\Sonata\\PageBundle\\Document\\Site')
                    ->end()
                ->end()
            ->end()
